...
public class NotiController implements iNotiController {
	...
	public synchronized void show() {
		...
		case SS_NORMAL:
		{
			notiBuilder.setSmallIcon(R.drawable.normal);
		}	break;
		case SS_CALL:
		{
			notiBuilder.setSmallIcon(R.drawable.call);
		}	break;
		case SS_ERROR:
		{
			notiBuilder.setSmallIcon(R.drawable.error);
		}	break;
		}
		...
		Intent onNotiClickIntent = new Intent(m_context, MainActivity.class);
		...
		Intent onClearIntent = new Intent(m_context, MainActivity.class);
		...
		notiBuilder.addAction(R.drawable.diconnect,"disconnect", pendingOnClearIntent);

		/* setup pending intent for "Launch" button */
		Intent onLaunchIntent = new Intent(m_context, MainActivity.class);
		...
		notiBuilder.addAction(R.drawable.open, "launch", pendingOnLaunchIntent);
